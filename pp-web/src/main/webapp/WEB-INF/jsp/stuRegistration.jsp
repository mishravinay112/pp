...
<body>
  <div class="container clearfix">
    <div class="conact-form">
      ...
      <p>&nbsp;</p>
      <form:form method="POST" action="registration.do" modelAttribute="Registration" autocomplete="off">
        <h4>
          ...
          <tr>
            <td><div class="form-control">
                ...
                <label>
                  ...
                  </p> <form:input path="city" class="inputControl" placeholder="City" required="autofocus" maxlength="20"
            ...
            <td><div class="form-control">
                ...
                <label>
                  ...
                  </p> <form:input path="state" class="inputControl" placeholder="State" required="autofocus" maxlength="20"
                    onkeypress="return Alphabets(event)" /> </label>
              </div>
            </td>
          </tr>
          <tr>
            <td><div class="form-control">
                ...
                <label>
                  ...
                  </p> <form:select path="course.courseId" class="inputControl" id="courseId">
                ...
                <label>
                  <p>
                    ...
                    <c:forEach items="${year}" var="refYear">
                      <form:option value="${refYear.yearId}" label="${refYear.year}" />
                    </c:forEach>
                  </form:select> </label>
              </div>
            </td>
