...
<body>
	...
	<div class="container clearfix">
		<div class="conact-form">
			...
			<form:form method="POST" action="stuSignIn.do"
				...
				<table width="100%" border="0">
					...
					<tr>
						<td><div class="form-control">
								<label> <small class="required"></small> <input
									type="checkbox" id="rememberMe" /> Remember Me
								</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label> <a
									href="forgotPassword.do">Forgot Password</a></label>
							</div></td>
					</tr>
					<tr>
